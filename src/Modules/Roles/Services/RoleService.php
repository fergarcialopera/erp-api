...
final class RoleService
{
    ...
    public function patch(string $roleId, PatchRoleDTO $dto): ?array
    {
        $currentStmt = $this->pdo->prepare(
            'SELECT name, slug, description, is_active FROM roles WHERE id::text = :id LIMIT 1'
        );
    ...
    public function softDelete(string $roleId): bool
    {
        $stmt = $this->pdo->prepare(
