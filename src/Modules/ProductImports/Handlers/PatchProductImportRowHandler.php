...
final class PatchProductImportRowHandler
{
    ...
    public function __invoke(Request $request): Response
    {
        try {
            ...
            $rowId = (string) $request->getAttribute('row_id', '');
            if ($importId === '' || $rowId === '') {
                return ApiResponse::error($request, 404, 'Not Found', 'Import row not found');
            }
            ...
            return ApiResponse::success($request, $this->service->setRowDecision($importId, $rowId, $decision));
