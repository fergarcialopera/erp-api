...
final class GetAuditActivityHandler
{
    ...
    public function __invoke(Request $request): Response
    {
        try {
            ...
            if ($id === '') {
                return ApiResponse::error($request, 400, 'Bad Request', 'Missing audit activity id');
            }
            ...
            if ($item === null) {
                return ApiResponse::error($request, 404, 'Not Found', 'Audit activity not found');
            }
