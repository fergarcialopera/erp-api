...
return static function (Router $router, array $handlers): array {
    ...
    $router->addRoute('GET', '/api/v1/lockers', fn ($request) => $handlers['listLockers']($request));
    $router->addRoute('GET', '/api/v1/lockers/tree', fn ($request) => $handlers['listLockersWithCompartments']($request));
    $router->addRoute('GET', '/api/v1/lockers/{locker_id}', fn ($request) => $handlers['getLocker']($request));
    $router->addRoute('POST', '/api/v1/lockers', fn ($request) => $handlers['createLocker']($request));
    $router->addRoute('PATCH', '/api/v1/lockers/{locker_id}', fn ($request) => $handlers['patchLocker']($request));
    $router->addRoute('DELETE', '/api/v1/lockers/{locker_id}', fn ($request) => $handlers['deleteLocker']($request));
