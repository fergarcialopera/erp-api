...
return static function (Router $router, array $handlers): array {
    ...
    $router->addRoute('GET', '/api/v1/product-imports', fn ($request) => $handlers['listProductImports']($request));
    $router->addRoute('POST', '/api/v1/product-imports', fn ($request) => $handlers['createProductImport']($request));
    $router->addRoute('PATCH', '/api/v1/product-imports/{import_id}/rows/{row_id}', fn ($request) => $handlers['patchProductImportRow']($request));
    $router->addRoute('PATCH', '/api/v1/product-imports/{import_id}/rows', fn ($request) => $handlers['patchProductImportRows']($request));
    $router->addRoute('GET', '/api/v1/product-imports/{import_id}/rows', fn ($request) => $handlers['listProductImportRows']($request));
    $router->addRoute('POST', '/api/v1/product-imports/{import_id}/confirm', fn ($request) => $handlers['confirmProductImport']($request));
    $router->addRoute('POST', '/api/v1/product-imports/{import_id}/cancel', fn ($request) => $handlers['cancelProductImport']($request));
    $router->addRoute('GET', '/api/v1/product-imports/{import_id}', fn ($request) => $handlers['getProductImport']($request));
    ...
    $router->addRoute('GET', '/api/v1/sub-brands', fn ($request) => $handlers['listSubBrands']($request));
    $router->addRoute('POST', '/api/v1/sub-brands', fn ($request) => $handlers['createSubBrand']($request));
    $router->addRoute('GET', '/api/v1/sub-brands/{sub_brand_id}', fn ($request) => $handlers['getSubBrand']($request));
    $router->addRoute('PATCH', '/api/v1/sub-brands/{sub_brand_id}', fn ($request) => $handlers['patchSubBrand']($request));
    $router->addRoute('DELETE', '/api/v1/sub-brands/{sub_brand_id}', fn ($request) => $handlers['deleteSubBrand']($request));
    $router->addRoute('GET', '/api/v1/species', fn ($request) => $handlers['listSpecies']($request));
    $router->addRoute('POST', '/api/v1/species', fn ($request) => $handlers['createSpecies']($request));
    $router->addRoute('GET', '/api/v1/species/{species_id}', fn ($request) => $handlers['getSpecies']($request));
    $router->addRoute('PATCH', '/api/v1/species/{species_id}', fn ($request) => $handlers['patchSpecies']($request));
    $router->addRoute('DELETE', '/api/v1/species/{species_id}', fn ($request) => $handlers['deleteSpecies']($request));
    $router->addRoute('GET', '/api/v1/specialties', fn ($request) => $handlers['listSpecialties']($request));
    $router->addRoute('POST', '/api/v1/specialties', fn ($request) => $handlers['createSpecialty']($request));
    $router->addRoute('GET', '/api/v1/specialties/{specialty_id}', fn ($request) => $handlers['getSpecialty']($request));
    $router->addRoute('PATCH', '/api/v1/specialties/{specialty_id}', fn ($request) => $handlers['patchSpecialty']($request));
    $router->addRoute('DELETE', '/api/v1/specialties/{specialty_id}', fn ($request) => $handlers['deleteSpecialty']($request));
    $router->addRoute('GET', '/api/v1/product-tags', fn ($request) => $handlers['listProductTags']($request));
    $router->addRoute('POST', '/api/v1/product-tags', fn ($request) => $handlers['createProductTag']($request));
    $router->addRoute('GET', '/api/v1/product-tags/{product_tag_id}', fn ($request) => $handlers['getProductTag']($request));
    $router->addRoute('PATCH', '/api/v1/product-tags/{product_tag_id}', fn ($request) => $handlers['patchProductTag']($request));
    $router->addRoute('DELETE', '/api/v1/product-tags/{product_tag_id}', fn ($request) => $handlers['deleteProductTag']($request));
    ...
    return [
        ...
        'GET /api/v1/product-imports' => ['SUPER_ADMIN'],
        'POST /api/v1/product-imports' => ['SUPER_ADMIN'],
        're:/^PATCH \\/api\\/v1\\/product-imports\\/[^\\/]+\\/rows\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        're:/^PATCH \\/api\\/v1\\/product-imports\\/[^\\/]+\\/rows$/' => ['SUPER_ADMIN'],
        're:/^GET \\/api\\/v1\\/product-imports\\/[^\\/]+\\/rows$/' => ['SUPER_ADMIN'],
        're:/^POST \\/api\\/v1\\/product-imports\\/[^\\/]+\\/confirm$/' => ['SUPER_ADMIN'],
        're:/^POST \\/api\\/v1\\/product-imports\\/[^\\/]+\\/cancel$/' => ['SUPER_ADMIN'],
        're:/^GET \\/api\\/v1\\/product-imports\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        ...
        'GET /api/v1/sub-brands' => ['STAFF'],
        'POST /api/v1/sub-brands' => ['SUPER_ADMIN'],
        're:/^GET \\/api\\/v1\\/sub-brands\\/[^\\/]+$/' => ['STAFF'],
        're:/^PATCH \\/api\\/v1\\/sub-brands\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        're:/^DELETE \\/api\\/v1\\/sub-brands\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        'GET /api/v1/species' => ['STAFF'],
        'POST /api/v1/species' => ['SUPER_ADMIN'],
        're:/^GET \\/api\\/v1\\/species\\/[^\\/]+$/' => ['STAFF'],
        're:/^PATCH \\/api\\/v1\\/species\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        're:/^DELETE \\/api\\/v1\\/species\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        'GET /api/v1/specialties' => ['STAFF'],
        'POST /api/v1/specialties' => ['SUPER_ADMIN'],
        're:/^GET \\/api\\/v1\\/specialties\\/[^\\/]+$/' => ['STAFF'],
        're:/^PATCH \\/api\\/v1\\/specialties\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        're:/^DELETE \\/api\\/v1\\/specialties\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        'GET /api/v1/product-tags' => ['STAFF'],
        'POST /api/v1/product-tags' => ['SUPER_ADMIN'],
        're:/^GET \\/api\\/v1\\/product-tags\\/[^\\/]+$/' => ['STAFF'],
        're:/^PATCH \\/api\\/v1\\/product-tags\\/[^\\/]+$/' => ['SUPER_ADMIN'],
        're:/^DELETE \\/api\\/v1\\/product-tags\\/[^\\/]+$/' => ['SUPER_ADMIN'],
